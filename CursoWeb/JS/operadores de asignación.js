...
document.getElementById("resulmux").innerHTML = " x *= 4 es equivalente a x = x * 4 (siendo ahora x=12) es: " + x;
document.getElementById("resuldiv").innerHTML = " x /= 4 es equivalente a x = x / 4 (siendo ahora x=12) es: " + x;
document.getElementById("resulresto").innerHTML = " x %= 4 es equivalente a x = x % 4 (siendo ahora x=12) es: " + x;